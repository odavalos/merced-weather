...
ghcn <- read_csv("data/GHCN_USC00045532.csv")
...
max.graph <- daily.summary.stats %>%
  ...
  scale_x_continuous(expand = expansion(0),
                     ...
                     name = NULL) +
  labs(title = "Daily High Temperature at Merced Regional Airport",
       ...
       caption = paste("Records begin on June 1, 1899.",
...
ggsave("graphs/DailyHighTemp_USC00045532.png", plot = max.graph2,
       width = 8, height = 4)
